...
class Wrapper
{
    ...
    */
    ...
    {
        return $this->_driver->target->create($target);
    }
    /**
    * @param array $action
    * @return array
    ...
    * @return array
    */
    public function addTargetAndSendMessage($target, $actionId, $messageContent)
    {
    ...
    */
    public function createTargetAndAddToSegment($targetObject, $segmentId)
    {
        ...
        $targetId = $response['body']['id'];
        $response = $this->_driver->segment->addToSegment($targetId, $segmentId);
        return $response;
    }
